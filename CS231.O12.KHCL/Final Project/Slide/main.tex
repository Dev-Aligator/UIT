...
\begin{frame}
    \onehalfspacing
        ...
        \begin{block}{The luminance comparison function $\ell(x,y)$}
            ...
            \begin{itemize}
                \item $\mu_{\textbf{x}}, \hspace{0.2em} \mu_{\textbf{y}}$: Mean luminance of the first and second image.
                \item $C_1 = (K_1 L)^2$: where L = 255 for 8-bit component images.
                \item $K_1 = 0.01$: Default value
            \end{itemize}
        \end{block}
...
\begin{frame}
    \onehalfspacing
        ...
        \begin{block}{The luminance comparison function $\c(x,y)$}
            {\Large
            \begin{center}
                $ c(x,y) = \dfrac{2\sigma_{\textbf{x}} \sigma_{\textbf{y}} + C_1}{\sigma^2_{\textbf{x}} + \sigma^2_{\textbf{y}} + C_1} $
            \end{center}
            }
            \hspace{8em}\rule{0.5\textwidth}{0.4pt}
            \begin{itemize}
...
\begin{frame}
    \onehalfspacing
        ...
        We evaluate 3 methods on detecting changes 
        der full supervision.
